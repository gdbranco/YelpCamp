...
router.get("/:id", function(req, res) {
    Campground.findById(req.params.id).populate({
        ...
        found.comments.sort(function(l, r) {
            return l.qtd_likes < r.qtd_likes
        });
