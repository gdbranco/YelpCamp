...
$("#form_comment-new").submit(function(event){
                       ...
                       <div class="col-md-12">
                               <div class="card">
                                       <div class="card-block">
                                               ...
                                               <form class="form_comment-delete" action="/campgrounds/<%=camp._id%>/comments/${data._id$}" method="POST">
   ...
   $(this).find('.form-control').innerHTML('');
});
...
$("#comments-list").on('submit','.form_comment-edit',function(e){
   ...
   var formAction = $(this).attr('action');
   var original = $(this).parent().parent('.card');
   $.ajax({
         url: formAction,
         data: commentItem,
         type: 'PUT',
         ...
         success: function(data){
            ...
            this.originalItem.html(
               `
                ...
                <div class="container">
                       <form class="form_comment-edit" action="/campgrounds/<%=camp._id%>/comments/${data._id$}" method="post">
