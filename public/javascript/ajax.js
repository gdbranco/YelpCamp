...
$('#search-camps').on('keyup', 'input', function(e) {
        ...
        $.ajax({
                ...
                success: function(data) {
                        originalList.html("");
                        if (data.flash) {
                                $("#search-camps").notify(data.flash.msg, {
                                        position: "top",
                                        className: data.flash.type
                                });
                        }
                        else {
...
$("#select_camp").select2({
        ...
        ajax: {
                ...
                processResults: function(data, params) {
                        ...
                        if (data.flash) {
                                $("#select_camp").notify(data.flash.msg, {
                                        position: "top",
                                        className: data.flash.type
                                });
                        }
...
$("#form_comment-new").submit(function(event) {
        ...
        $.post(formAction, formData, function(data) {
               ...
               `
                        ...
                        $("#comments-list").notify(data.flash.msg, {
                                position: "top",
                                className: data.flash.type
                        });
                }
...
$("#comments-list").on('submit', '.form_comment-edit', function(e) {
        ...
        $.ajax({
               ...
               `
                                ...
                                original.notify(data.flash.msg, {
                                        position: "top",
                                        className: data.flash.type
                                });
